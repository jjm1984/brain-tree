...
*Promoted from peripheral to yellow on 2026-07-05 — actively relevant, partially planted, correction pass still needed.*

Job change underway. This is the first moment where work, vocation, identity, and the root impulse ('to understand the world and translate it') are in direct contact.

## Seed material (from feedback entry-002, entry-005)

The transition to Tactical Marketing Manager: the discomfort is the function, not the domain. Domain knowledge (technical depth, product expertise) is the moat; the learning curve is craft not substance.

The machinery work (civil or agricultural) as income bridge: chosen not just for income but as a decompression chamber — physical, embodied, low cognitive load, mind free to learn. Restoration and income in the same motion. Aliveness-adjacent. Worth watching: does it metabolise as worth, as guilt, or as something the worth-machine simply cannot measure and therefore leaves alone?
...
- **leaf-role-turnkey-bi** — Business Intelligence & Field Operations, Turnkey BI, Toowoomba (pre-2019)
- **leaf-role-bigsky** — Co-Founder, Big Sky Technologies
- **leaf-role-trimble** — Precision Farming Specialist, Trimble Agriculture (APAC)
- **leaf-role-swarmfarm** — Customer Success Manager → Head of Field Operations, SwarmFarm Robotics
- **leaf-role-agco** — Regional Tactical Marketing Manager APA, AGCO Australia Limited (2026-06-29 onward, current)
- **leaf-military-service-gap** — Military service, named elsewhere in the tree (soldierly virtues, force-preservation) but never given its own role-node; genuinely open whether it belongs here as a role or stays an exposed-root/lived-experience thread feeding phil-courage and phil-stoicism

A candidate role-sport-officiating-gap (umpiring/officiating) was proposed in the same session and then retracted after J confirmed the inference — drawn from what was edited *out* of the public bio document — was simply wrong, not a real gap. Correction logged 2026-07-05: an inference drawn from what was removed from a document is weaker evidence than it looked; absence-in-a-public-bio doesn't reliably imply presence-in-real-life.
...
What is work actually for in J's value system — instrument, expression, or both? How does the root impulse ('understand and translate the world') map onto specific vocational choices?

## Connected to

philo-meaning, philo-core-impulse, philo-people-before-process, branch-self-worth-identity (Doing/Coherence), branch-aliveness, branch-daily-architecture
